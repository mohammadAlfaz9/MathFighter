 ...
 Phaser.Scene
 {
    ...
    create(){
        ...
        start_button.on(
          ...
          this.physics.add.collider(this.slash,this.player,this.spriteHit,null,this)
          this.physics.add.collider(this.slash,this.enemy,this.spriteHit,null,this)
  ...
  if (this.correctAnswer === false && !this.enemyAttack) {
    ...
    gameStart() {
        ...
        this.questionText = this.add.text(this.gameHalfWidth, 100, '0', {  fontSize: "32p", color: "#000", fontFamily: "Arial, sans-serif"});
        this.createButtons();
